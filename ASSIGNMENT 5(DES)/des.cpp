...
int main()
{
    // A 64 bit key
    string key;
    cout << "Enter a 64 bit (8 letter) key: ";
    cin >> key;

    // A block of plain text of 64 bits
    cout << "Enter a 64 bit (8 letter) plain text: ";
    cin >> pt;
    ...
    int i = 15;
    int j = 0;
    string x= "0110011101101111011100000110000101101100011101100110100101101100";
    cout<<x.size()<<endl;
    while (i > j)
    {
    ...
    cout << "Decrypted text: " << binaryToText(decrypted) << endl;
